...
To specify which machine to install the ELK server on, we create a group called “elk” in the hosts file.   Then add the private IP of the ELK VM and specified python3 with “ansible_python_interpreter=/usr/bin/python3”.  The image below illustrates the changes to make in the configuration file.
